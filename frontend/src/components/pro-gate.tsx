...
export function ProButton({
  ...
  return (
    <UpgradeDialog feature={feature}>
      <div className={`inline-flex shrink-0 items-center justify-center gap-2 rounded-lg border border-border bg-background px-2.5 h-8 text-sm font-medium cursor-pointer opacity-75 hover:bg-muted transition-all ${props.className || ""}`}>
